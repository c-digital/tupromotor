                ...
                @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <!--<li class="aiz-side-nav-item">
                                <a href="/admin/customer_to_be_approved" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">Clientes por aprobar</span>
                                </a>
                            </li>
                            -->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('10', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="/admin/report-sales" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Reporte de ventas') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="/admin/report-orders-per-status" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Reporte de pedidos por estatus') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="/admin/report-per-business-type" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Reporte por tipo de negocio') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="/admin/ranking-sales-per-shop" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Ránking de compras por tienda') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="/admin/report-product" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Reporte de producto') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
