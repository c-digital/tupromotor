...
<head>
    ...
    <meta name="facebook-domain-verification" content="6u31efugpodmkt34irakkxsfivf55m" />
...
<body>
    ...
    <script>
        ...
        position = navigator.geolocation.getCurrentPosition(function (position) {
            $('[name=getCurrentPositionLat]').val(position.coords.latitude);
            $('[name=getCurrentPositionLong]').val(position.coords.longitude);
        },
        function () {
        }, options);
    </script>

    <input type="text" name="getCurrentPositionLat">
    <input type="text" name="getCurrentPositionLong">
