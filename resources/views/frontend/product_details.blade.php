                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                @if ($detailedProduct->user->shop->min_amount)
                                    <div class="block col-auto ml">
                                        <small class="mr-2 opacity-50">{{ translate('Pedido mínimo de la tienda')}}: </small>{{ $detailedProduct->user->shop->min_amount }} {{  translate('Bs.') }}
                                    </div>
                                @endif
                            </div>
