            ...
            <div class="row">
                    ...
                    <table class="table table-borderless">
                        ...
                        @if($order->delivery_status == 'confirmed')
                            @php
                                ...
                                $link = 'https://maps.google.com/?ll=' . $address->latitude . ',' . $address->longitude;
                                $link = 'https://www.google.com/maps/search/?api=1&zoom=20&query=' . $address->latitude . ',' . $address->longitude;
                            @endphp
                            <tr>
                                <td class="w-50 fw-600">{{ translate('Google Maps')}}:</td>
                                <td><a target="_blank" href="{{ $link }}">Click aquí para ver mapa</a></td>
                            </tr>
                        @endif
                    </table>
                </div>
                <div class="col-lg-6">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td class="w-50 fw-600">{{  'Estado de la entrega' }}</td>
                            <td>{{ translate($status) }}</td>
                        </tr>
                        <tr>
                            <td class="w-50 fw-600">{{  'Estado del pedido' }}:</td>
                            <td>{{ ($order->status) ? 'Aprobado' : 'Pendiente' }}</td>
                        </tr>
                        <tr>
