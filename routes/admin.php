...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // Reports
    Route::get('report-orders-per-status', 'ReportController@orders_per_status');
    Route::get('report-per-business-type', 'ReportController@per_business_type');
    Route::get('ranking-sales-per-shop', 'ReportController@ranking_sales_per_shop');
    Route::get('report-product', 'ReportController@report_product');
    Route::get('report-sales', 'ReportController@report_sales');

    // Customer to be approved
    Route::get('customer_to_be_approved', 'CustomerToBeApprovedController@index');
    Route::get('customer_to_be_approved/approved/{id}', 'CustomerToBeApprovedController@approved');
    Route::get('customer_to_be_approved/decline/{id}', 'CustomerToBeApprovedController@decline');
