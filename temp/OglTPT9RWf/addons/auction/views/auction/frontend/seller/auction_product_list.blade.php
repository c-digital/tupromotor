...
<div class="row gutters-10 justify-content-center">
        ...
        <div class="col-md-4 mx-auto mb-3" >
            <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
              ...
              <div class="px-3 pt-3 pb-3">
                  <div class="h4 fw-700 text-center">{{ max(0, Auth::user()->seller->remaining_auction_uploads) }}</div>
    ...
    <div class="col-md-4 mx-auto mb-3" >
        <a href="{{ route('auction_products.create')}}">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            @if($product->auction_start_date > strtotime("now"))
                                <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('auction_products.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
