...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        ...
        <div class="col text-right">
            <a href="{{ route('wholesale-products.create') }}" class="btn btn-circle btn-info">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('wholesale-products.edit', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('wholesale-products.destroy', $product->id)}}" title="{{ translate('Delete') }}">
